...
//兌換頁活動網址
$exchange_url="https://www.shiseido-event.com/2017haku/exchange.html";
			...
			switch ($func) {
				...
				case "StoreGetInfo":
					if (isset($_POST['sn'])) {
						...
						//比對兌換碼, 確認兌換狀態
						if ($return_OK==1) {
							$sqlStr='SELECT c_name, s_name, t_no, t_name, t_mobile, t_email, t_is_exchange, t_is_valid, DATE_ADD(t_apply_date, INTERVAL '.EXCHANGE_EXPIRE_DATE.' DAY) as t_expire_date FROM Tester, Store, City WHERE c_no=t_c_no AND s_no=t_s_no AND t_e_no=:event_no AND t_sn_no=:sn_no';
